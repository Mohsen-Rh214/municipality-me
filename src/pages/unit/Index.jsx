...
const headCells = [
  // { id: "id", label: "#" },
  { id: "unit_title", label: "عنوان" },
  { id: "unit_owner", label: "مالک" },
  { id: "unit_type", label: "نوع کاربری" },
  { id: "unit_certificate", label: "شماره سند" },
...
const Unit = () => {
  ...
  return (
    <div className='page'>
      <ActionBar title='اطلاعات واحد' icon={titleIcon}>
        <AddBtn onClick={() => navigate("/panel/add-unit")} />
                ...
                {(listData || []).map((item, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell
                        onClick={() => {
                          navigate(`/panel/edit-unit/${item.id}`)
                        }}
                      >
                        <p>{item.tittle || "_"}</p>
                      </TableCell>
                      <TableCell>
                        <p>{!item.owner ? "_" : item.owner.get_fullname}</p>
                      </TableCell>
                      <TableCell>
                        <p>{item.usage_type || "_"}</p>
                      </TableCell>
                      <TableCell>
                        <p>{item.doc_number || "-"}</p>
                      </TableCell>
