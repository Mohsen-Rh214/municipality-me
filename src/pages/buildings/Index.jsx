...
const Buildings = () => {
    ...
    // list data and api
    let endpoint = `/building/api/Building/`
    ...
    return (
        <div className='page'>
            ...
            >
                ...
                <AddBtn onClick={() => navigate("/panel/add-building")} />
                                ...
                                {(listData || []).map((item, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell
                                                onClick={() => {
                                                    navigate(`/panel/edit-building/${item.id}`)
                                                }}
                                            >
                                                <p>{item.tittle || "_"}</p>
                                            </TableCell>
